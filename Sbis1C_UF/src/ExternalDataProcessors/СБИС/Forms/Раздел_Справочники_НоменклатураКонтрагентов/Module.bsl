...
Функция ОбновитьКонтент(ЛокальныйКэш) Экспорт
	...
	СтраницаОперацийРеестра = Кэш.ОбщиеФункции.СбисПолучитьЭлементФормы(Кэш, СтраницыПанели, "НоменклатураКонтрагентов");
	...
	Если ЗначениеЗаполнено(ГлавноеОкно.КонтрагентНоменклатуры) Тогда
		...
		стрФильтр.НаименованиеСБИС	= ГлавноеОкно.ФильтрНаименованиеНоменклатуры;
